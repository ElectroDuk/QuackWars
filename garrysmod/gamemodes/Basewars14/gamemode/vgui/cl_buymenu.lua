...
-------------------------------------------*/
    ...
    local donortab = vgui.Create( "DButton" )
    donortab:SetParent( ShopMenu )  
    donortab:SetPos( 580, 35 )
    donortab:SetText( "Donator Shop" )
    donortab:SetTextColor( Color(255, 255, 255, 255) )
    donortab:SetSize( 110, 30 )
    donortab.Paint = function()
    surface.SetDrawColor( 90, 60, 0, 200 )
    surface.DrawRect( 0, 0, donortab:GetWide(), donortab:GetTall() )
    end
    donortab.DoClick = function()
        LocalPlayer():ConCommand( "bw_donatorshop" )
        ShopMenu:Remove()
        net.Start("bw_closeshopmenu")
        net.SendToServer()
    end
